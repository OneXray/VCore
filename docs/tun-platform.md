...
Windows 11 ARM64 已验证 activation、真实 VCore IPv4/IPv6 ICMP/raw packet 往返、loopback wake、DNS namespace、DIRECT TCP、runtime DNS 与普通 UDP、物理 source/interface 配对绑定、网络切换 fail-closed，以及独立 provider host 的跨 session 回收。VLESS/XHTTP/XUDP、SOCKS5、AnyTLS、两类链、rapid lifecycle、10 分钟 active pressure 与 x64-emulated AppX 也已通过。Windows 10 22H2、原生 x64 Windows、真实物理 IPv6、WACK 与正式 App/MSIX 仍待后续阶段。
