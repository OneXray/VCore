...
- [REALITY V1 wire](docs/reality-wire-protocol.md)
- [rustls REALITY 发布计划](docs/rustls-reality-release.md)
- [TUN 流量 Controller](docs/controller-api.md)
- [DNS 与 ICMP](docs/tun-icmp-dns.md)
...
VCore 使用 MIT License。依赖和派生源码声明见 [`THIRD_PARTY_NOTICES.md`](THIRD_PARTY_NOTICES.md)。
